...
public class Beszallitoi_PPM extends JPanel 
{
    ...
    public Beszallitoi_PPM() 
    {
        ...
        gorgeto.setBounds(20, 204, 1148, 241);
        add(gorgeto);
        
        modell = new DefaultTableModel();
        modell.setColumnIdentifiers(new Object[]{"Cikkszám","Cikk megnevezés", "Beszállító", "Beérkezve", "Fehasználva", "Zárolt", "Felszabadítva", "PPM", "Osztály", "Csoport", "Típus"});
        ...
        public void actionPerformed(ActionEvent e)
         {
            try
            {
                ...
                for(int szamlalo = 0; szamlalo < cikkszamok.size(); szamlalo++)
                {
                    ...
                    { 
                        modell.addRow(new Object[]{cikkszam, megnevezes.get(szamlalo), beszallito, beerkezve, felhasznalva, selejt, visszakonyvelve, ppm,  osztaly, csoport, tipus});
                    }                    
                }
                table.setModel(modell);
