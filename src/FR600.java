...
public class FR600 extends JPanel {
    ...
    public FR600() {
        ...
        JLabel lblNewLabel = new JLabel("FR600 OQC adatgyűjtő");
        ...
        String[] tipus = {"FR600","FR600 INTER"};
        ...
        JLabel lblNewLabel_17 = new JLabel("FritzBox");
        lblNewLabel_17.setBounds(792, 136, 71, 14);
        add(lblNewLabel_17);
        
        JLabel lblNewLabel_18 = new JLabel("Repeater");
        lblNewLabel_18.setBounds(880, 136, 85, 14);
        add(lblNewLabel_18);
        ...
        public void actionPerformed(ActionEvent e)
         {
            try 
            {
                ...
                else
                {
                    ...
                    String sql = "INSERT INTO qualitydb.OQC_FR600 (Datum, Tesztelo,Tipus,Artikel_szam,Raklapszam,Szeriaszam_doboz,Szeriaszam_termek,Egyezes,Teszt_tipusa,Wlan_macadress_prod,"
                            + "Wlan_macadress_gui,Mac_egyezes,Wlan_tx_gui_Fritzbox,Wlan_rx_gui_Fritzbox,Wlan_tx_gui_Fritzrepeater,Wlan_rx_gui_Fritzrepeater,"
                            ...
                            + "'"+ tx_gui2.getText() +"','"+ rx_gui2.getText() +"',"
    ...
    class Hany_tesztelve implements KeyListener                                                                                                 //billentyűzet figyelő eseménykezelő, kiszámolja mennyit kell ellenőrizni
    {
        ...
        {    
            ...
            if (key == KeyEvent.VK_ENTER)                                                                                               //ha az entert nyomják le akkor hívódik meg
            {
                ...
                String sql = "select count(raklapszam)from qualitydb.OQC_FR600 where raklapszam = '"+ raklap_mezo.getText() +"'";
