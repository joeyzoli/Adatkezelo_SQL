...
public class OQC_tesztadatok extends JPanel {
    ...
    public OQC_tesztadatok() {
        ...
        datum.addActionListener(new Datumszarint());
        add(datum);
        ...
        JComboBox<String> ellenor_box = new JComboBox<String>();
        ...
        modell2.setColumnIdentifiers(new Object[]{"Munkanap", "SUM"});
        table = new JTable(){
    ...
    class Datumszarint implements ActionListener                                                                                        //termék gomb megnyomáskor hívodik meg
    {
