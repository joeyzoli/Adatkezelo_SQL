			...
			try
			 {
				...
				String[] adatbazisok = {"qualitydb.Vevoireklamacio_alapadat", "qualitydb.Vevoireklamacio_felelosok", "qualitydb.Vevoireklamacio_detekt", "qualitydb.Vevoireklamacio_kepek", "qualitydb.Vevoireklamacio_excel"};
